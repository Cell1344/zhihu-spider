...
################################################################################
## Form generated from reading UI file 'dialog_articleset.ui'
##
...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 505, 933))
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QCoreApplication.translate("Dialog", u"\u6587\u7ae0\u5c5e\u6027\u8bbe\u7f6e", None))
        self.groupBox_math.setTitle(QCoreApplication.translate("Dialog", u"\u6570\u5b66\u516c\u5f0f", None))
        ...
        self.groupBox_subdata.setTitle(QCoreApplication.translate("Dialog", u"\u81ea\u5b9a\u4e49\u4fee\u6b63(\u652f\u6301python\u7684\u6b63\u5219)", None))
